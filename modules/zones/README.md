...
| <a name="output_route53_zone_primary_name_server"></a> [route53\_zone\_primary\_name\_server](#output\_route53\_zone\_primary\_name\_server) | The Route 53 name server that created the SOA record. |
